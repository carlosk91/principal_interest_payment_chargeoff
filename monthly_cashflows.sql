...
GROUP BY VINTAGE, TRANSACTION_MONTH, ORIGINAL_TERM_TO_MATURITY, CREDIT_SEGMENT, VERTICAL
ORDER BY VINTAGE, TRANSACTION_MONTH, ORIGINAL_TERM_TO_MATURITY, CREDIT_SEGMENT, VERTICAL
